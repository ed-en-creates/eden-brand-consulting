...
const ARTIFACTS_DIR = 'C:\\Users\\Edo State Public Lib\\.gemini\\antigravity\\brain\\015143e9-4fd8-4e4c-b50c-3a6280b1364b';
...
async function processImages() {
  ...
  for (let i = 0; i < FASHION_FILES.length; i++) {
    ...
    const outputPath = path.join(OUTPUT_DIR, `fashion-${String(i + 1).padStart(2, '0')}.jpg`);
    try {
