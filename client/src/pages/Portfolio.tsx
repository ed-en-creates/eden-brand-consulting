 ...
 * - Full portfolio gallery with filtering
 * - Detailed project cards with modal on click
    ...
    <div className="min-h-screen bg-background/40 backdrop-blur-lg text-foreground">
      ...
      <main className="pt-32 pb-24">
        <div className="container">
          ...
          >
            <h1 className="text-display mb-4">Our Portfolio</h1>
                  ...
                  <div className="relative overflow-hidden rounded-lg aspect-square bg-foreground/5 border border-border hover-lift">
                    ...
                    >
                      <div className="text-right w-full">
                        ...
                        <p className="text-xs text-white/50 mt-3 font-medium uppercase tracking-wider">
                          Click to view →
                        </p>
                      </div>
                    </motion.div>
